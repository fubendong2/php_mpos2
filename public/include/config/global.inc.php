...
$config['wallet']['host'] = 'localhost:18003';
$config['wallet']['username'] = 'innovationcoinrpc';
$config['wallet']['password'] = 'EPkcuAz3xBbDFsAjCpA3ZBtQVXzqhhUKZPfRDYfz1iNS';
 ...
 **/
$config['gettingstarted']['coinname'] = 'Innovationcoin';
...
$config['memcache']['keyprefix'] = 'mpos_ivc_';
